...
class CalandearView: UIViewController {
    struct Color {
...
extension CalandearView: CVCalendarViewDelegate, CVCalendarMenuViewDelegate {
...
extension CalandearView: CVCalendarViewAppearanceDelegate {
